...
class BMP24Bit
{
    ...
    /// Calls Import
    /// </summary>
    public BMP24Bit(string filename)
    {
        Import(filename);
    }
    ...
    public string Import(string filename)
    {
        ...
        try
        {
            inFile = File.Open(filename + ".bmp", FileMode.Open);
        }
        catch(Exception e)
        {
    ...
    private uint ReadUInt(FileStream file, byte byteAmount)
    {
    ...
    public string Export(string filename)
    {
        ...
        try
        {
            outFile = File.Create(filename + ".bmp");
        }
        catch (Exception e)
        {
    ...
    private void WriteUInt(FileStream file, uint value, byte byteAmount)
    {
